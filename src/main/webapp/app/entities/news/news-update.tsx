...
export interface INewsUpdateState {
  isNew: boolean;
}

export class NewsUpdate extends React.Component<INewsUpdateProps, INewsUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/news');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tpwebsiteApp.news.home.createOrEditLabel">
              <Translate contentKey="tpwebsiteApp.news.home.createOrEditLabel">Create or edit a News</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : newsEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="newsTitleLabel" for="newsTitle">
                ...
                <AvGroup>
                  <Label id="newsContentLabel" for="newsContent">
