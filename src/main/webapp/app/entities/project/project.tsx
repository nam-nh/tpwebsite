    ...
    return (
      <div>
        <h2 id="project-heading">
          <Translate contentKey="tpwebsiteApp.project.home.title">Projects</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="tpwebsiteApp.project.home.createLabel">Create new Project</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('tpwebsiteApp.project.home.search')}
                  />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('projectName')}>
                    <Translate contentKey="tpwebsiteApp.project.projectName">Project Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('minSalary')}>
                    <Translate contentKey="tpwebsiteApp.project.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('maxSalary')}>
                    <Translate contentKey="tpwebsiteApp.project.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {projectList.map((project, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{project.minSalary}</td>
                    <td>{project.maxSalary}</td>
