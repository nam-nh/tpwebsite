...
import { getSearchEntities, getEntities, reset } from './item-group.reducer';
...
export interface IItemGroupState extends IPaginationBaseState {
  search: string;
}

export class ItemGroup extends React.Component<IItemGroupProps, IItemGroupState> {
  state: IItemGroupState = {
    search: '',
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('tpwebsiteApp.itemGroup.home.search')}
                  />
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('itemGroupName')}>
                    <Translate contentKey="tpwebsiteApp.itemGroup.itemGroupName">Item Group Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('itemGroupDescription')}>
                    <Translate contentKey="tpwebsiteApp.itemGroup.itemGroupDescription">Item Group Description</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="tpwebsiteApp.itemGroup.category">Category</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
...
const mapStateToProps = ({ itemGroup }: IRootState) => ({
  ...
  totalItems: itemGroup.totalItems,
  links: itemGroup.links,
  entity: itemGroup.entity,
  updateSuccess: itemGroup.updateSuccess
});
