...
import { getSearchEntities, getEntities, reset } from './category.reducer';
    ...
    return (
      <div>
        <h2 id="category-heading">
          <Translate contentKey="tpwebsiteApp.category.home.title">Categories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="tpwebsiteApp.category.home.createLabel">Create new Category</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('tpwebsiteApp.category.home.search')}
                  />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('categoryName')}>
                    <Translate contentKey="tpwebsiteApp.category.categoryName">Category Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('categoryDescription')}>
                    <Translate contentKey="tpwebsiteApp.category.categoryDescription">Category Description</Translate>{' '}
