    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tpwebsiteApp.category.home.createOrEditLabel">
              <Translate contentKey="tpwebsiteApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="categoryNameLabel" for="categoryName">
                    <Translate contentKey="tpwebsiteApp.category.categoryName">Category Name</Translate>
                  </Label>
                  <AvField
