...
export class ServiceDeleteDialog extends React.Component<IServiceDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.serviceEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="tpwebsiteApp.service.delete.question">
          <Translate contentKey="tpwebsiteApp.service.delete.question" interpolate={{ id: serviceEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-service" color="danger" onClick={this.confirmDelete}>
