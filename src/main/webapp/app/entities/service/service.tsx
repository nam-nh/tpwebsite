    ...
    return (
      <div>
        <h2 id="service-heading">
          <Translate contentKey="tpwebsiteApp.service.home.title">Services</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="tpwebsiteApp.service.home.createLabel">Create new Service</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('tpwebsiteApp.service.home.search')}
                  />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('serviceName')}>
                    <Translate contentKey="tpwebsiteApp.service.serviceName">Service Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('serviceDescription')}>
                    <Translate contentKey="tpwebsiteApp.service.serviceDescription">Service Description</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('serviceImage')}>
                    <Translate contentKey="tpwebsiteApp.service.serviceImage">Service Image</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
