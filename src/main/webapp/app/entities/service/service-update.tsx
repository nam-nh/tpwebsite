    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tpwebsiteApp.service.home.createOrEditLabel">
              <Translate contentKey="tpwebsiteApp.service.home.createOrEditLabel">Create or edit a Service</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
