  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="tpwebsiteApp.service.detail.title">Service</Translate> [<b>{serviceEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="serviceName">
                <Translate contentKey="tpwebsiteApp.service.serviceName">Service Name</Translate>
              </span>
            </dt>
            ...
            <dd>{serviceEntity.serviceDescription}</dd>
            <dt>
              <span id="serviceImage">
                <Translate contentKey="tpwebsiteApp.service.serviceImage">Service Image</Translate>
              </span>
            </dt>
            <dd>{serviceEntity.serviceImage}</dd>
          </dl>
