...
import tp.web.application.security.*;
import tp.web.application.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.GET, "/api/item-groups").permitAll()
            .antMatchers(HttpMethod.GET, "/api/item-sub-groups").permitAll()
