...
import tp.web.application.config.Constants;
import tp.web.application.domain.Authority;
import tp.web.application.domain.User;
import tp.web.application.repository.AuthorityRepository;
import tp.web.application.repository.UserRepository;
import tp.web.application.security.AuthoritiesConstants;
import tp.web.application.service.MailService;
import tp.web.application.service.UserService;
import tp.web.application.service.dto.PasswordChangeDTO;
import tp.web.application.service.dto.UserDTO;
import tp.web.application.web.rest.errors.ExceptionTranslator;
import tp.web.application.web.rest.vm.KeyAndPasswordVM;
import tp.web.application.web.rest.vm.ManagedUserVM;
