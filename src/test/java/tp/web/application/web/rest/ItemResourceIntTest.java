...
public class ItemResourceIntTest {
    ...
    private static final Long UPDATED_ITEM_QUANTITY = 2L;
     ...
     *
     * @see tp.web.application.repository.search.ItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createItem() throws Exception {
        ...
        assertThat(testItem.getItemPrice()).isEqualTo(DEFAULT_ITEM_PRICE);
    ...
    @Test
    @Transactional
    public void checkItemQuantityIsRequired() throws Exception {
        int databaseSizeBeforeTest = itemRepository.findAll().size();
        // set the field null
    ...
    public void getAllItems() throws Exception {
        ...
        restItemMockMvc.perform(get("/api/items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].itemQuantity").value(hasItem(DEFAULT_ITEM_QUANTITY.intValue())))
    ...
    public void getItem() throws Exception {
        ...
        restItemMockMvc.perform(get("/api/items/{id}", item.getId()))
            ...
            .andExpect(jsonPath("$.itemQuantity").value(DEFAULT_ITEM_QUANTITY.intValue()))
    ...
    public void updateItem() throws Exception {
        ...
        assertThat(testItem.getItemPrice()).isEqualTo(UPDATED_ITEM_PRICE);
