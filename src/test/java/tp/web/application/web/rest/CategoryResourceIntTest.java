...
import tp.web.application.domain.Category;
import tp.web.application.repository.CategoryRepository;
import tp.web.application.repository.search.CategorySearchRepository;
...
public class CategoryResourceIntTest {
     ...
     *
     * @see tp.web.application.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
